...
const CHENNAI_TRANSIT_SEED: SeedRoute[] = [
  ...
  {
    mode: "bus",
    name: "MTC 102 Broadway - Kelambakkam",
    startLocation: "Broadway",
    endLocation: "Kelambakkam",
    stops: [
      ...
      { label: "Sholinganallur", latitude: 12.90101, longitude: 80.22793, radiusMeters: 500 },
      { label: "Navalur", latitude: 12.8261, longitude: 80.2332, radiusMeters: 500 },
      { label: "SIPCOT", latitude: 12.8175, longitude: 80.2348, radiusMeters: 500 },
      { label: "Kelambakkam", latitude: 12.7845, longitude: 80.2223, radiusMeters: 500 }
    ]
  },
  {
    mode: "bus",
  ...
  },
  {
    ...
    endLocation: "Tambaram",
    stops: [
      { label: "Chennai Beach", latitude: 13.09283, longitude: 80.29205, radiusMeters: 1500 },
      { label: "Chennai Fort", latitude: 13.08716, longitude: 80.28703, radiusMeters: 1500 },
      { label: "Park Town", latitude: 13.0822, longitude: 80.2757, radiusMeters: 1500 },
      { label: "Chennai Park", latitude: 13.0807, longitude: 80.27541, radiusMeters: 1500 },
      { label: "Chennai Egmore", latitude: 13.0732, longitude: 80.2609, radiusMeters: 1500 },
      { label: "Chetpet", latitude: 13.0701, longitude: 80.2414, radiusMeters: 1500 },
      { label: "Nungambakkam", latitude: 13.0606, longitude: 80.2397, radiusMeters: 1500 },
      { label: "Kodambakkam", latitude: 13.0521, longitude: 80.2214, radiusMeters: 1500 },
      { label: "Mambalam", latitude: 13.0386, longitude: 80.2212, radiusMeters: 1500 },
      { label: "Saidapet", latitude: 13.0245, longitude: 80.2283, radiusMeters: 1500 },
      { label: "Guindy", latitude: 13.0082, longitude: 80.2125, radiusMeters: 1500 },
      { label: "St. Thomas Mount", latitude: 13.0039, longitude: 80.1961, radiusMeters: 1500 },
      { label: "Pazhavanthangal", latitude: 12.9952, longitude: 80.1882, radiusMeters: 1500 },
      { label: "Meenambakkam", latitude: 12.98741, longitude: 80.1765, radiusMeters: 1500 },
      { label: "Trisulam", latitude: 12.9817, longitude: 80.1668, radiusMeters: 1500 },
      { label: "Pallavaram", latitude: 12.96753, longitude: 80.1491, radiusMeters: 1500 },
      { label: "Chromepet", latitude: 12.95168, longitude: 80.14621, radiusMeters: 1500 },
      { label: "Tambaram Sanatorium", latitude: 12.93961, longitude: 80.14043, radiusMeters: 1500 },
      { label: "Tambaram", latitude: 12.9249, longitude: 80.1267, radiusMeters: 1500 }
    ]
  },
  {
    mode: "train",
    ...
    endLocation: "Avadi",
    stops: [
      { label: "Chennai Central", latitude: 13.0829, longitude: 80.2759, radiusMeters: 1500 },
      { label: "Moore Market Complex", latitude: 13.0831, longitude: 80.2742, radiusMeters: 1500 },
      { label: "Basin Bridge", latitude: 13.09265, longitude: 80.26773, radiusMeters: 1500 },
      { label: "Vyasarpadi Jeeva", latitude: 13.11862, longitude: 80.26246, radiusMeters: 1500 },
      { label: "Perambur", latitude: 13.11144, longitude: 80.24687, radiusMeters: 1500 },
      { label: "Perambur Carriage Works", latitude: 13.1122, longitude: 80.2366, radiusMeters: 1500 },
      { label: "Perambur Loco Works", latitude: 13.1129, longitude: 80.2258, radiusMeters: 1500 },
      { label: "Villivakkam", latitude: 13.10882, longitude: 80.20781, radiusMeters: 1500 },
      { label: "Korattur", latitude: 13.11513, longitude: 80.18484, radiusMeters: 1500 },
      { label: "Pattaravakkam", latitude: 13.12385, longitude: 80.1447, radiusMeters: 1500 },
      { label: "Ambattur", latitude: 13.11434, longitude: 80.15479, radiusMeters: 1500 },
      { label: "Tirumullaivoyal", latitude: 13.13073, longitude: 80.13141, radiusMeters: 1500 },
      { label: "Annanur", latitude: 13.1253, longitude: 80.1151, radiusMeters: 1500 },
      { label: "Avadi", latitude: 13.11496, longitude: 80.10188, radiusMeters: 1500 }
    ]
  },
  {
    mode: "train",
    name: "Chennai Central - Tiruvallur Suburban",
    startLocation: "Chennai Central",
    endLocation: "Tiruvallur",
    stops: [
      { label: "Chennai Central", latitude: 13.0829, longitude: 80.2759, radiusMeters: 1500 },
      { label: "Basin Bridge", latitude: 13.09265, longitude: 80.26773, radiusMeters: 1500 },
      { label: "Vyasarpadi Jeeva", latitude: 13.11862, longitude: 80.26246, radiusMeters: 1500 },
      ...
      { label: "Ambattur", latitude: 13.11434, longitude: 80.15479, radiusMeters: 1500 },
      { label: "Avadi", latitude: 13.11496, longitude: 80.10188, radiusMeters: 1500 },
      { label: "Pattabiram", latitude: 13.1207, longitude: 80.0634, radiusMeters: 1500 },
      { label: "Thiruninravur", latitude: 13.1252, longitude: 80.0354, radiusMeters: 1500 },
      { label: "Veppampattu", latitude: 13.1287, longitude: 80.0076, radiusMeters: 1500 },
      { label: "Tiruvallur", latitude: 13.1362, longitude: 79.9114, radiusMeters: 1500 }
    ]
  },
  {
    mode: "train",
    ...
    stops: [
      ...
      { label: "Chennai Fort", latitude: 13.08716, longitude: 80.28703, radiusMeters: 1500 },
      { label: "Park Town", latitude: 13.0822, longitude: 80.2757, radiusMeters: 1500 },
      { label: "Chintadripet", latitude: 13.0731, longitude: 80.2691, radiusMeters: 1500 },
      { label: "Chepauk", latitude: 13.0621, longitude: 80.2795, radiusMeters: 1500 },
      { label: "Tiruvallikeni", latitude: 13.0551, longitude: 80.2793, radiusMeters: 1500 },
      { label: "Light House", latitude: 13.049, longitude: 80.2788, radiusMeters: 1500 },
      { label: "Mundakakanni Amman Koil", latitude: 13.0351, longitude: 80.2696, radiusMeters: 1500 },
      { label: "Thirumayilai", latitude: 13.0336, longitude: 80.2678, radiusMeters: 1500 },
      { label: "Mandaveli", latitude: 13.0266, longitude: 80.2644, radiusMeters: 1500 },
      { label: "Greenways Road", latitude: 13.0188, longitude: 80.2584, radiusMeters: 1500 },
      { label: "Kotturpuram", latitude: 13.0121, longitude: 80.2414, radiusMeters: 1500 },
      { label: "Kasturba Nagar", latitude: 12.9959, longitude: 80.257, radiusMeters: 1500 },
      { label: "Indira Nagar", latitude: 12.9963, longitude: 80.2489, radiusMeters: 1500 },
      { label: "Thiruvanmiyur", latitude: 12.98436, longitude: 80.25941, radiusMeters: 1500 },
      { label: "Taramani", latitude: 12.9851, longitude: 80.2414, radiusMeters: 1500 },
      { label: "Perungudi", latitude: 12.9767, longitude: 80.24, radiusMeters: 1500 },
      { label: "Velachery", latitude: 12.9793, longitude: 80.2209, radiusMeters: 1500 }
    ]
  },
  {
    mode: "custom",
